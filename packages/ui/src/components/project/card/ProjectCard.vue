		...
		<div v-if="layout === 'grid'" :class="[baseCardStyle, 'flex flex-col']">
			...
			<div class="p-4 flex flex-col gap-3 grow">
				...
				<div class="mt-auto flex flex-col gap-3 flex-wrap overflow-hidden justify-between grow">
					...
					<div class="pt-1 flex items-center justify-center w-full smart-clickable:allow-pointer-events [&>div]:w-full [&>div]:items-center [&>button]:w-full [&>button]:justify-center">
						<slot name="actions" />
					</div>
				</div>
			</div>
